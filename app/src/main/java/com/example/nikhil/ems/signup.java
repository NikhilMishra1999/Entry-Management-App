                ...
                if (TextUtils.isEmpty(pn)) {
                    ...
                    mFirebaseAuth.createUserWithEmailAndPassword(em,pass).addOnCompleteListener(signup.this, new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            ...
                            data d = new data(nam,em,pass,pn);
                            dataReference.child(id).setValue(d);
                            Toast.makeText(getApplication(),"Account Created Successfully"+"\n"+"Proceed to Check In!",
                                    Toast.LENGTH_SHORT).show();
                            Intent information = new Intent(getApplicationContext(),login.class);
                            getApplicationContext().startActivity(information);
